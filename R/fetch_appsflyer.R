#' fetch_appsflyer
#' A function to fetch AppsFlyer data from the windsor.ai API
#'
...
#' @examples
#' \dontrun{
#' my_appsflyer_data <- fetch_appsflyer(api_key = "your api key",
...
fetch_appsflyer <-
  function(api_key,
    ...
    json_data <- jsonlite::fromJSON(
      paste0(
        "https://connectors.windsor.ai/appsflyer?api_key=",
        api_key,
        "&fields=",
